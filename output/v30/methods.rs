...
impl<'a> Raw<'a> {
    ...
    pub async fn dump_txout_set(&self, path: String) -> Result<DumpTxoutSet> {
    ...
    pub async fn dump_txout_set_with(&self, path: String, opts: DumpTxoutSetOptions) -> Result<DumpTxoutSet> {
    ...
    pub async fn get_block_hash(&self, height: f64) -> Result<GetBlockHash> {
    ...
    pub async fn get_blockstats(&self, hash_or_height: f64) -> Result<GetBlockstats> {
    ...
    pub async fn get_blockstats_with(&self, hash_or_height: f64, opts: GetBlockstatsOptions) -> Result<GetBlockstats> {
    ...
    pub async fn get_chainstates(&self) -> Result<GetChainstates> {
    ...
    pub async fn get_chain_txstats(&self) -> Result<GetChainTxstats> {
    ...
    pub async fn get_chain_txstats_with(&self, opts: GetChainTxstatsOptions) -> Result<GetChainTxstats> {
        self.client.call_raw("getchaintxstats", &[json!(opts.nblocks), json!(opts.block_hash)]).await
    }
    ...
    pub async fn get_descriptor_activity(&self, block_hash_es: Vec<String>, scan_objects: Vec<serde_json::Value>) -> Result<GetDescriptorActivity> {
    ...
    pub async fn get_descriptor_activity_with(&self, block_hash_es: Vec<String>, scan_objects: Vec<serde_json::Value>, opts: GetDescriptorActivityOptions) -> Result<GetDescriptorActivity> {
    ...
    pub async fn get_mempoolcluster(&self, txid: String) -> Result<GetMempoolcluster> {
    ...
    pub async fn get_txout(&self, txid: String, n: f64) -> Result<serde_json::Value> {
    ...
    pub async fn get_txout_with(&self, txid: String, n: f64, opts: GetTxoutOptions) -> Result<serde_json::Value> {
    ...
    pub async fn get_txout_proof(&self, txids: Vec<String>) -> Result<GetTxoutProof> {
    ...
    pub async fn get_txout_proof_with(&self, txids: Vec<String>, opts: GetTxoutProofOptions) -> Result<GetTxoutProof> {
    ...
    pub async fn get_txout_set_info(&self) -> Result<GetTxoutSetInfo> {
    ...
    pub async fn get_txout_set_info_with(&self, opts: GetTxoutSetInfoOptions) -> Result<GetTxoutSetInfo> {
    ...
    pub async fn get_txspendingprev_out(&self, outputs: Vec<serde_json::Value>) -> Result<GetTxspendingprevOut> {
    ...
    pub async fn import_mempool(&self, filepath: String) -> Result<ImportMempool> {
        self.client.call_raw("importmempool", &[json!(filepath)]).await
    }
    ...
    pub async fn import_mempool_with(&self, filepath: String, opts: ImportMempoolOptions) -> Result<ImportMempool> {
        self.client.call_raw("importmempool", &[json!(filepath), json!(opts.options)]).await
    }
    ...
    pub async fn load_txout_set(&self, path: String) -> Result<LoadTxoutSet> {
    ...
    pub async fn prune_blockchain(&self, height: f64) -> Result<PruneBlockchain> {
    ...
    pub async fn scan_blocks(&self, action: String) -> Result<serde_json::Value> {
    ...
    pub async fn scan_blocks_with(&self, action: String, opts: ScanBlocksOptions) -> Result<serde_json::Value> {
    ...
    pub async fn scan_txout_set(&self, action: String) -> Result<serde_json::Value> {
    ...
    pub async fn scan_txout_set_with(&self, action: String, opts: ScanTxoutSetOptions) -> Result<serde_json::Value> {
    ...
    pub async fn verify_chain_with(&self, opts: VerifyChainOptions) -> Result<VerifyChain> {
        self.client.call_raw("verifychain", &[json!(opts.checklevel), json!(opts.nblocks)]).await
    }
    ...
    pub async fn verify_txout_proof(&self, proof: String) -> Result<VerifyTxoutProof> {
    ...
    pub async fn wait_for_block_height(&self, height: f64) -> Result<WaitForBlockHeight> {
    ...
    pub async fn wait_for_block_height_with(&self, height: f64, opts: WaitForBlockHeightOptions) -> Result<WaitForBlockHeight> {
    ...
    pub async fn getopen_rpc(&self) -> Result<GetopenRpc> {
    ...
    pub async fn add_peer_address(&self, address: String, port: f64) -> Result<AddPeerAddress> {
    ...
    pub async fn add_peer_address_with(&self, address: String, port: f64, opts: AddPeerAddressOptions) -> Result<AddPeerAddress> {
    ...
    pub async fn estimate_raw_fee(&self, conf_target: f64) -> Result<EstimateRawFee> {
    ...
    pub async fn estimate_raw_fee_with(&self, conf_target: f64, opts: EstimateRawFeeOptions) -> Result<EstimateRawFee> {
    ...
    pub async fn generate_to_address(&self, nblocks: f64, address: String) -> Result<GenerateToAddress> {
        self.client.call_raw("generatetoaddress", &[json!(nblocks), json!(address)]).await
    }
    ...
    pub async fn generate_to_address_with(&self, nblocks: f64, address: String, opts: GenerateToAddressOptions) -> Result<GenerateToAddress> {
        self.client.call_raw("generatetoaddress", &[json!(nblocks), json!(address), json!(opts.max_tries)]).await
    }
    ...
    pub async fn generate_to_descriptor(&self, num_blocks: f64, descriptor: String) -> Result<GenerateToDescriptor> {
    ...
    pub async fn generate_to_descriptor_with(&self, num_blocks: f64, descriptor: String, opts: GenerateToDescriptorOptions) -> Result<GenerateToDescriptor> {
    ...
    pub async fn get_mempool_feeratediagram(&self) -> Result<GetMempoolFeeratediagram> {
    ...
    pub async fn get_orphan_txs(&self) -> Result<serde_json::Value> {
    ...
    pub async fn get_orphan_txs_with(&self, opts: GetOrphanTxsOptions) -> Result<serde_json::Value> {
    ...
    pub async fn in_validate_block(&self, block_hash: String) -> Result<()> {
    ...
    pub async fn mockscheduler(&self, delta_time: f64) -> Result<()> {
    ...
    pub async fn sendmsg_to_peer(&self, peer_id: f64, msg_type: String, msg: String) -> Result<SendmsgToPeer> {
    ...
    pub async fn setmocktime(&self, times_tamp: f64) -> Result<()> {
        self.client.call_raw("setmocktime", &[json!(times_tamp)]).await
    }
    ...
    pub async fn syncwithvalidationinterfacequeue(&self) -> Result<()> {
    ...
    pub async fn get_blocktemplate(&self, template_request: serde_json::Value) -> Result<serde_json::Value> {
    ...
    pub async fn get_network_hashps_with(&self, opts: GetNetworkHashpsOptions) -> Result<GetNetworkHashps> {
        self.client.call_raw("getnetworkhashps", &[json!(opts.nblocks), json!(opts.height)]).await
    }
    ...
    pub async fn setban(&self, subnet: String, command: String) -> Result<()> {
    ...
    pub async fn setban_with(&self, subnet: String, command: String, opts: SetbanOptions) -> Result<()> {
        self.client.call_raw("setban", &[json!(subnet), json!(command), json!(opts.bantime), json!(opts.absolute)]).await
    }
    ...
    pub async fn set_networkactive(&self, state: bool) -> Result<SetNetworkactive> {
    ...
    pub async fn combine_psbt(&self, txs: Vec<String>) -> Result<CombinePsbt> {
        self.client.call_raw("combinepsbt", &[json!(txs)]).await
    }
    ...
    pub async fn combine_raw_transaction(&self, txs: Vec<String>) -> Result<CombineRawTransaction> {
        self.client.call_raw("combinerawtransaction", &[json!(txs)]).await
    }
    ...
    pub async fn convert_to_psbt_with(&self, hex_string: String, opts: ConvertToPsbtOptions) -> Result<ConvertToPsbt> {
        self.client.call_raw("converttopsbt", &[json!(hex_string), json!(opts.permit_sigdata), json!(opts.iswitness)]).await
    }
    ...
    pub async fn decode_raw_transaction_with(&self, hex_string: String, opts: DecodeRawTransactionOptions) -> Result<DecodeRawTransaction> {
        self.client.call_raw("decoderawtransaction", &[json!(hex_string), json!(opts.iswitness)]).await
    }
    ...
    pub async fn descriptor_process_psbt(&self, psbt: String, descriptors: Vec<serde_json::Value>) -> Result<DescriptorProcessPsbt> {
    ...
    pub async fn descriptor_process_psbt_with(&self, psbt: String, descriptors: Vec<serde_json::Value>, opts: DescriptorProcessPsbtOptions) -> Result<DescriptorProcessPsbt> {
        self.client.call_raw("descriptorprocesspsbt", &[json!(psbt), json!(descriptors), json!(opts.sighashtype), json!(opts.bip32derivs), json!(opts.final_ize)]).await
    }
    ...
    pub async fn fund_raw_transaction_with(&self, hex_string: String, opts: FundRawTransactionOptions) -> Result<FundRawTransaction> {
        self.client.call_raw("fundrawtransaction", &[json!(hex_string), json!(opts.options), json!(opts.iswitness)]).await
    }
    ...
    pub async fn join_psbts(&self, txs: Vec<String>) -> Result<JoinPsbts> {
        self.client.call_raw("joinpsbts", &[json!(txs)]).await
    }
    ...
    pub async fn sign_raw_transactionwith_key(&self, hex_string: String, privkeys: Vec<String>) -> Result<SignRawTransactionwithKey> {
        self.client.call_raw("signrawtransactionwithkey", &[json!(hex_string), json!(privkeys)]).await
    }
    ...
    pub async fn sign_raw_transactionwith_key_with(&self, hex_string: String, privkeys: Vec<String>, opts: SignRawTransactionwithKeyOptions) -> Result<SignRawTransactionwithKey> {
        self.client.call_raw("signrawtransactionwithkey", &[json!(hex_string), json!(privkeys), json!(opts.prev_txs), json!(opts.sighashtype)]).await
    }
    ...
    pub async fn test_mempoolaccept(&self, raw_txs: Vec<String>) -> Result<TestMempoolaccept> {
        self.client.call_raw("testmempoolaccept", &[json!(raw_txs)]).await
    }
    ...
    pub async fn test_mempoolaccept_with(&self, raw_txs: Vec<String>, opts: TestMempoolacceptOptions) -> Result<TestMempoolaccept> {
        self.client.call_raw("testmempoolaccept", &[json!(raw_txs), json!(opts.max_fee_rate)]).await
    }
    ...
    pub async fn create_multisig(&self, nrequired: f64, keys: Vec<String>) -> Result<CreateMultisig> {
        self.client.call_raw("createmultisig", &[json!(nrequired), json!(keys)]).await
    }
    ...
    pub async fn create_multisig_with(&self, nrequired: f64, keys: Vec<String>, opts: CreateMultisigOptions) -> Result<CreateMultisig> {
        self.client.call_raw("createmultisig", &[json!(nrequired), json!(keys), json!(opts.address_type)]).await
    }
    ...
    pub async fn estimate_smart_fee(&self, conf_target: f64) -> Result<EstimateSmartFee> {
    ...
    pub async fn estimate_smart_fee_with(&self, conf_target: f64, opts: EstimateSmartFeeOptions) -> Result<EstimateSmartFee> {
    ...
    pub async fn sign_messagewith_priv_key(&self, privkey: String, message: String) -> Result<SignMessagewithPrivKey> {
        self.client.call_raw("signmessagewithprivkey", &[json!(privkey), json!(message)]).await
    }
    ...
    pub async fn get_addressesby_label(&self, label: String) -> Result<GetAddressesbyLabel> {
    ...
    pub async fn get_receivedby_address(&self, address: String) -> Result<GetReceivedbyAddress> {
    ...
    pub async fn get_receivedby_address_with(&self, address: String, opts: GetReceivedbyAddressOptions) -> Result<GetReceivedbyAddress> {
    ...
    pub async fn get_receivedby_label(&self, label: String) -> Result<GetReceivedbyLabel> {
    ...
    pub async fn get_receivedby_label_with(&self, label: String, opts: GetReceivedbyLabelOptions) -> Result<GetReceivedbyLabel> {
    ...
    pub async fn import_pruned_funds(&self, raw_transaction: String, txout_proof: String) -> Result<()> {
        self.client.call_raw("importprunedfunds", &[json!(raw_transaction), json!(txout_proof)]).await
    }
    ...
    pub async fn key_poolrefill(&self) -> Result<()> {
    ...
    pub async fn key_poolrefill_with(&self, opts: KeyPoolrefillOptions) -> Result<()> {
    ...
    pub async fn list_receivedby_address(&self) -> Result<ListReceivedbyAddress> {
    ...
    pub async fn list_receivedby_address_with(&self, opts: ListReceivedbyAddressOptions) -> Result<ListReceivedbyAddress> {
    ...
    pub async fn list_receivedby_label(&self) -> Result<ListReceivedbyLabel> {
    ...
    pub async fn list_receivedby_label_with(&self, opts: ListReceivedbyLabelOptions) -> Result<ListReceivedbyLabel> {
    ...
    pub async fn load_wallet(&self, filename: String) -> Result<LoadWallet> {
        self.client.call_raw("loadwallet", &[json!(filename)]).await
    }
    ...
    pub async fn load_wallet_with(&self, filename: String, opts: LoadWalletOptions) -> Result<LoadWallet> {
        self.client.call_raw("loadwallet", &[json!(filename), json!(opts.load_on_startup)]).await
    }
    ...
    pub async fn send(&self, outputs: Vec<serde_json::Value>) -> Result<Send> {
        self.client.call_raw("send", &[json!(outputs)]).await
    }

    /// `send` — with all optional arguments via [`SendOptions`].
    ///
    /// EXPERIMENTAL warning: this call may be changed in future releases.

    pub async fn send_with(&self, outputs: Vec<serde_json::Value>, opts: SendOptions) -> Result<Send> {
    ...
    pub async fn send_all(&self, recipients: Vec<serde_json::Value>) -> Result<SendAll> {
    ...
    pub async fn send_all_with(&self, recipients: Vec<serde_json::Value>, opts: SendAllOptions) -> Result<SendAll> {
    ...
    pub async fn sendmany(&self, amounts: serde_json::Value) -> Result<serde_json::Value> {
    ...
    pub async fn sendmany_with(&self, amounts: serde_json::Value, opts: SendmanyOptions) -> Result<serde_json::Value> {
        self.client.call_raw("sendmany", &[json!(amounts), json!(opts.dummy), json!(opts.min_conf), json!(opts.comment), json!(opts.subtractfeefrom), json!(opts.replaceable), json!(opts.conf_target), json!(opts.estimate_mode), json!(opts.fee_rate), json!(opts.verbose)]).await
    }
    ...
    pub async fn send_to_address_with(&self, address: String, amount: f64, opts: SendToAddressOptions) -> Result<serde_json::Value> {
        self.client.call_raw("sendtoaddress", &[json!(address), json!(amount), json!(opts.comment), json!(opts.comment_to), json!(opts.subtractfeefromamount), json!(opts.replaceable), json!(opts.conf_target), json!(opts.estimate_mode), json!(opts.avoid_reuse), json!(opts.fee_rate), json!(opts.verbose)]).await
    }
    ...
    pub async fn set_walletflag(&self, flag: String) -> Result<SetWalletflag> {
    ...
    pub async fn set_walletflag_with(&self, flag: String, opts: SetWalletflagOptions) -> Result<SetWalletflag> {
    ...
    pub async fn sign_raw_transactionwith_wallet(&self, hex_string: String) -> Result<SignRawTransactionwithWallet> {
    ...
    pub async fn sign_raw_transactionwith_wallet_with(&self, hex_string: String, opts: SignRawTransactionwithWalletOptions) -> Result<SignRawTransactionwithWallet> {
        self.client.call_raw("signrawtransactionwithwallet", &[json!(hex_string), json!(opts.prev_txs), json!(opts.sighashtype)]).await
    }
    ...
    pub async fn simulate_raw_transaction_with(&self, opts: SimulateRawTransactionOptions) -> Result<SimulateRawTransaction> {
        self.client.call_raw("simulaterawtransaction", &[json!(opts.raw_txs), json!(opts.options)]).await
    }
    ...
    pub async fn wallet_passphrase(&self, passphrase: String, time_out: f64) -> Result<()> {
    ...
    pub async fn wallet_process_psbt_with(&self, psbt: String, opts: WalletProcessPsbtOptions) -> Result<WalletProcessPsbt> {
        self.client.call_raw("walletprocesspsbt", &[json!(psbt), json!(opts.sign), json!(opts.sighashtype), json!(opts.bip32derivs), json!(opts.final_ize)]).await
    }
