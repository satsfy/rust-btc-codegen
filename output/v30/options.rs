...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`dumptxoutset`]: ../methods/struct.Raw.html#method.dump_tx_out_set_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`getaddednodeinfo`]: ../methods/struct.Raw.html#method.get_add_ed_node_info_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`getblockstats`]: ../methods/struct.Raw.html#method.get_block_stats_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`getchaintxstats`]: ../methods/struct.Raw.html#method.get_chain_tx_stats_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`getorphantxs`]: ../methods/struct.Raw.html#method.get_orphan_tx_s_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`getreceivedbyaddress`]: ../methods/struct.Raw.html#method.get_received_by_address_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`getreceivedbylabel`]: ../methods/struct.Raw.html#method.get_received_by_label_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`gettxout`]: ../methods/struct.Raw.html#method.get_tx_out_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`gettxoutproof`]: ../methods/struct.Raw.html#method.get_tx_out_proof_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`gettxoutsetinfo`]: ../methods/struct.Raw.html#method.get_tx_out_set_info_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`keypoolrefill`]: ../methods/struct.Raw.html#method.key_pool_refill_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`listreceivedbyaddress`]: ../methods/struct.Raw.html#method.list_received_by_address_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`listreceivedbylabel`]: ../methods/struct.Raw.html#method.list_received_by_label_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`migratewallet`]: ../methods/struct.Raw.html#method.mig_rate_wallet_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`scanblocks`]: ../methods/struct.Raw.html#method.scan_block_s_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct ScanBlockSOptions {
    ...
    ///
    /// Default in Bitcoin Core: `no default`.
    pub scan_objects: Option<Vec<String>>,
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`scantxoutset`]: ../methods/struct.Raw.html#method.scan_tx_out_set_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`sendmany`]: ../methods/struct.Raw.html#method.send_many_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`setban`]: ../methods/struct.Raw.html#method.set_ban_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`setwalletflag`]: ../methods/struct.Raw.html#method.set_wallet_flag_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`signrawtransactionwithkey`]: ../methods/struct.Raw.html#method.sign_raw_transaction_with_key_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct SignRawTransactionWithKeyOptions {
    ...
    ///
    /// Default in Bitcoin Core: `no default`.
    pub prev_tx_s: Option<Vec<serde_json::Value>>,
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`signrawtransactionwithwallet`]: ../methods/struct.Raw.html#method.sign_raw_transaction_with_wallet_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
...
pub struct SimulateRawTransactionOptions {
    ...
    ///
    /// Default in Bitcoin Core: `no default`.
    pub raw_tx_s: Option<Vec<String>>,
    ///
    ///
    /// Default in Bitcoin Core: `no default`.
    pub options: Option<serde_json::Value>,
...
/// Every field is `None` by default; setting a field to `Some(_)` causes the value to be sent as the corresponding positional argument. Unset fields are serialised as JSON `null`, which Bitcoin Core treats as 'use the documented default'.
///
/// [`testmempoolaccept`]: ../methods/struct.Raw.html#method.test_mempool_accept_with
#[derive(Clone, Debug, Default, serde::Serialize)]
#[serde(rename_all = "camelCase")]
